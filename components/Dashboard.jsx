...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    const envKey = process.env.NEXT_PUBLIC_GEMINI_API_KEY || process.env.VITE_GEMINI_API_KEY;
    const envModel = process.env.NEXT_PUBLIC_GEMINI_MODEL || process.env.VITE_GEMINI_MODEL;
  ...
  <div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
    <div className="flex justify-between items-start">
      <div className="space-y-3">
        ...
        <h3 className={`text-3xl font-black text-slate-900 transition-colors tracking-tight`}>{value}</h3>
      </div>
